...
public class UsmpApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
         ...
         * //Crea Usuario
         * Usuarios Admin1=new Usuarios("JUAN MATIAS",
         * "GUTIERREZ CASANI","matias_gutierrez@usmp.pe", "1254",72412912,
         * 977358975,"perfil.jpg","Peru","Arequipa",usu);
         * Usuarios Admin2=new Usuarios("OSCAR RENE",
         * "PINEDA FLORES","oscar_pineda@usmp.pe", "1254",73412912,
         * 999988866,"perfil.jpg","Peru","Arequipa",usu);
         * Usuarios Admin3=new Usuarios("ANDREA NIKOLE",
         * "ALVA CHAVEZ","andrea_alva@usmp.pe", "1254",74412912,
         * 999777555,"perfil.jpg","Peru","Arequipa",usu);
         * Usuarios Admin4=new Usuarios("GERALDINE LOANA",
         * "YANQUE FLORES","geraldine_yanque@usmp.pe", "1254",75412912,
         * 999777666,"perfil.jpg","Peru","Arequipa",usu);
         ...
         * //Bolsa de trabajo
         * Bolsa_de_trabajo C=new Bolsa_de_trabajo("ANALISTA DE SOPORTE INFORMATICO",
         * "SELEKTO CONSULTORES EN RECURSOS HUMANOS", 1,
         * "Descripcion de bolsa de trabajo","Ingles-Intermedio","Informacion adicional"
         * ,c2,j1 );
         ...
         * //Eventos
         * Eventos G=new Eventos("Eventos 1", "Eventos de prueba",
         * "La perla","01/11/2023","08/11/2023","imagen1.jpg",B);
         * eveSvc.saveOrUpdate(G);
         * System.out.println("Evento guardado");
         * //Noticia
         * Noticias H=new Noticias("NOTICIA IMPACTANTE",
         * "Noticia de ejemplo","imagen1.jpg", B);
         * nSvc.saveOrUpdate(H);
         * Noticias I=new Noticias("NOTICIA IMPACTANTE",
         * "Noticia de ejemplo","imagen1.jpg", B);
         * nSvc.saveOrUpdate(I);
